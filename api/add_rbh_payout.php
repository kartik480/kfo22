...
try {
    ...
    if (!$payoutTypeResult) {
        // Create RBH Payout type if it doesn't exist
        $createPayoutTypeQuery = "INSERT INTO tbl_payout_type (payout_name, status, created_at) VALUES ('RBH Payout', 1, NOW())";
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'RBH Payout added successfully',
        'data' => $insertedRecord
    ]);
