...
try {
    ...
    error_log("Team members query for manager_id: " . $managerId);
    error_log("Team members query returned " . $result->num_rows . " rows");
    ...
    error_log("Error in fetch_team_members.php: " . $e->getMessage());
