...
echo "<h2>Database Analysis: tbl_user Table</h2>";
...
try {
    ...
    echo "<h3>2. Users by Status:</h3><ul>";
    ...
    echo "<h3>3. All Users Details:</h3>";
    ...
    // 4. Test the exact query used in fetch_sdsa_reporting_users.php
    echo "<h3>4. Testing the Reporting Users Query:</h3>";
    ...
    // 5. Check which users are being excluded and why
    echo "<h3>5. Users Excluded from Reporting Dropdown:</h3>";
    ...
    echo "<ul>";
    echo "<li><strong>Total users:</strong> $totalCount</li>";
    echo "<li><strong>Users in reporting dropdown:</strong> " . ($result ? $result->num_rows : 'Query failed') . "</li>";
    echo "<li><strong>Excluded users:</strong> " . $excludedResult->num_rows . "</li>";
    echo "</ul>";
    
    if ($result && $result->num_rows < $totalCount) {
        echo "<p style='color: orange;'><strong>Issue identified:</strong> Some users are being excluded from the reporting dropdown.</p>";
        echo "<p><strong>Possible solutions:</strong></p>";
        echo "<ul>";
        echo "<li>Check if any users have status = 'Inactive' and change them to 'Active'</li>";
        echo "<li>Check if any users have empty or NULL firstName/lastName fields</li>";
        echo "<li>Verify that all 6 users have proper name data</li>";
        echo "</ul>";
    } else if ($result && $result->num_rows == $totalCount) {
        echo "<p style='color: green;'><strong>All users are included in the reporting dropdown.</strong></p>";
    }
