...
try {
    ...
    error_log("Managing Director Partner Users API called with username: " . $loggedInUsername);
    ...
    // Query to fetch all partner users created by username "10000"
    $query = "SELECT 
                id,
                username,
                alias_name,
    ...
    // Get statistics for partner users created by "10000"
    $statsQuery = "SELECT 
    ...
    error_log("Managing Director API: Successfully fetched " . count($formattedUsers) . " partner users created by '10000' for Managing Director " . $loggedInUsername);
    
    echo json_encode([
        'status' => 'success',
        'message' => 'Partner users created by username "10000" fetched successfully for Managing Director',
        'data' => $formattedUsers,
        ...
        'filter_info' => [
            'created_by_filter' => '10000',
            'table' => 'tbl_partner_users',
            'filter_description' => 'Only partner users created by username "10000"'
        ],
        'api_info' => [
            'version' => '1.0',
