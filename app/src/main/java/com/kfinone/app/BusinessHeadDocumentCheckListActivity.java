...
public class BusinessHeadDocumentCheckListActivity extends AppCompatActivity {

    private static final String TAG = "BusinessHeadDocumentCheckListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_head_document_check_list);
    ...
    private void loadDocumentData() {
        ...
        new Thread(() -> {
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (json.getString("status").equals("success")) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            Toast.makeText(BusinessHeadDocumentCheckListActivity.this, 
                        ...
                        runOnUiThread(() -> {
                            showLoading(false);
                            Toast.makeText(BusinessHeadDocumentCheckListActivity.this, "Error: " + errorMsg, Toast.LENGTH_LONG).show();
                        });
                    }
                } else {
                    ...
                    runOnUiThread(() -> {
                        showLoading(false);
                        Toast.makeText(BusinessHeadDocumentCheckListActivity.this, "Server error: " + responseCode, Toast.LENGTH_LONG).show();
                    });
                }
            } catch (Exception e) {
                ...
                runOnUiThread(() -> {
                    showLoading(false);
                    Toast.makeText(BusinessHeadDocumentCheckListActivity.this, "Error loading documents: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
            }
        }).start();
    }
