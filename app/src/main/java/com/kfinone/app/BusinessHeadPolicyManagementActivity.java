...
public class BusinessHeadPolicyManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Debug logging
        android.util.Log.d("BHPolicy", "BusinessHeadPolicyManagementActivity onCreate started");
        
        setContentView(R.layout.activity_business_head_policy_management);
        
        android.util.Log.d("BHPolicy", "Layout set successfully");
        ...
        android.util.Log.d("BHPolicy", "User data received - Username: " + userName + ", UserID: " + userId);
        
        initializeViews();
        setupClickListeners();
        updateWelcomeMessage();
        
        android.util.Log.d("BHPolicy", "BusinessHeadPolicyManagementActivity onCreate completed");
    }
