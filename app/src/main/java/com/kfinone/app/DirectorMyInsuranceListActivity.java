...
public class DirectorMyInsuranceListActivity extends AppCompatActivity implements InsuranceListAdapter.OnInsuranceActionClickListener {

    private static final String TAG = "DirectorMyInsuranceList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_director_my_insurance_list);
    ...
    private void initializeViews() {
        ...
        // Setup RecyclerView
        insuranceAdapter = new InsuranceListAdapter(insuranceList, this);
    ...
    @Override
    public void onViewClick(InsuranceItem insuranceItem) {
        // Handle view click
        Toast.makeText(this, "Viewing: " + insuranceItem.getDisplayName(), Toast.LENGTH_SHORT).show();
        Log.d(TAG, "View clicked for insurance: " + insuranceItem.getDisplayName());
    ...
    @Override
    public void onEditClick(InsuranceItem insuranceItem) {
        // Handle edit click
        Toast.makeText(this, "Editing: " + insuranceItem.getDisplayName(), Toast.LENGTH_SHORT).show();
        Log.d(TAG, "Edit clicked for insurance: " + insuranceItem.getDisplayName());
