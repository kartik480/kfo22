...
public class ActivePartnerAdapter extends RecyclerView.Adapter<ActivePartnerAdapter.ViewHolder> {

    private List<ActivePartnerItem> partnerList;
    private OnItemClickListener listener;

    public interface OnItemClickListener {
        void onEditClick(ActivePartnerItem item);
        void onDeleteClick(ActivePartnerItem item);
    }

    public ActivePartnerAdapter(List<ActivePartnerItem> partnerList, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_active_partner, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ActivePartnerItem item = partnerList.get(position);
    ...
    public void updateData(List<ActivePartnerItem> newList) {
        this.partnerList = newList;
