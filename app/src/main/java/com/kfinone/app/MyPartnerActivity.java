...
public class MyPartnerActivity extends AppCompatActivity implements PartnerUserAdapter.OnPartnerUserActionListener {
    ...
    private void loadPartnerData() {
        showLoading(true);
        String url = BASE_URL + "get_partner_users_fallback.php";
                ...
                try {
                    ...
                    if ("success".equals(status)) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            // Set all fields using the new getter/setter methods
