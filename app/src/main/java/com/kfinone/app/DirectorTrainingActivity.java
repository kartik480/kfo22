...
public class DirectorTrainingActivity extends AppCompatActivity {

    private static final String TAG = "DirectorTrainingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_director_training);
    ...
    private void initializeViews() {
        ...
        if (titleText != null) {
            titleText.setText("Training Center");
        }
    ...
    private void setupClickListeners() {
        ...
        profileBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, DirectorProfileActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        seminarsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, DirectorSeminarActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
        ...
        policyBox.setOnClickListener(v -> {
            ...
            intent.putExtra("SOURCE_PANEL", "DIRECTOR_TRAINING");
            passUserDataToIntent(intent);
            startActivity(intent);
        });
        ...
        newsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, DirectorNewsActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        policyImagesBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, DirectorPolicyImagesActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
    }
