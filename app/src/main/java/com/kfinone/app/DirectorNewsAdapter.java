...
public class DirectorNewsAdapter extends RecyclerView.Adapter<DirectorNewsAdapter.NewsViewHolder> {

    private List<DirectorNewsActivity.NewsItem> newsList;
    private Context context;

    public DirectorNewsAdapter(Context context, List<DirectorNewsActivity.NewsItem> newsList) {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_director_news, parent, false);
        return new NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        DirectorNewsActivity.NewsItem news = newsList.get(position);
    ...
    public void updateNewsList(List<DirectorNewsActivity.NewsItem> newNewsList) {
        this.newsList.clear();
