...
public class ManagingDirectorSalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "MDSalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Managing Director
        titleText.setText("Managing Director Salaried List");
        welcomeText.setText("Managing Director Salaried List");
        descriptionText.setText("Manage and filter salaried employee data for Managing Director operations");
    }
