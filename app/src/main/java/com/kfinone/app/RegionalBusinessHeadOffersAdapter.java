...
public class RegionalBusinessHeadOffersAdapter extends RecyclerView.Adapter<RegionalBusinessHeadOffersAdapter.OfferViewHolder> {

    private List<RegionalBusinessHeadOffersActivity.OfferItem> offersList;
    private Context context;

    public RegionalBusinessHeadOffersAdapter(Context context, List<RegionalBusinessHeadOffersActivity.OfferItem> offersList) {
    ...
    public OfferViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_regional_business_head_offer, parent, false);
        return new OfferViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OfferViewHolder holder, int position) {
        RegionalBusinessHeadOffersActivity.OfferItem offer = offersList.get(position);
    ...
    public void updateOffersList(List<RegionalBusinessHeadOffersActivity.OfferItem> newOffersList) {
