                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        if (success) {
                            ...
                            Toast.makeText(RegionalBusinessHeadTypeOfLoanActivity.this, "Loaded " + videoList.size() + " videos", Toast.LENGTH_SHORT).show();
                            
                        } else {
                            String message = response.getString("message");
                            Toast.makeText(RegionalBusinessHeadTypeOfLoanActivity.this, "API Error: " + message, Toast.LENGTH_SHORT).show();
                            loadFallbackVideos();
                        }
