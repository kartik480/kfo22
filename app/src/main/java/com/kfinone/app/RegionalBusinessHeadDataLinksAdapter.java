...
public class RegionalBusinessHeadDataLinksAdapter extends RecyclerView.Adapter<RegionalBusinessHeadDataLinksAdapter.ViewHolder> {
    
    private Context context;
    private List<DataIcon> dataIcons;
    
    public RegionalBusinessHeadDataLinksAdapter(Context context, List<DataIcon> dataIcons) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_rbh_data_link_icon, parent, false);
        return new ViewHolder(view);
    }
    
    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DataIcon icon = dataIcons.get(position);
        ...
        holder.iconImageView.setImageResource(R.drawable.ic_reports);
    ...
    public void updateData(List<DataIcon> newDataIcons) {
        this.dataIcons.clear();
        this.dataIcons.addAll(newDataIcons);
