...
public class RegionalBusinessHeadNewsAdapter extends RecyclerView.Adapter<RegionalBusinessHeadNewsAdapter.NewsViewHolder> {

    private List<RegionalBusinessHeadNewsActivity.NewsItem> newsList;
    private Context context;

    public RegionalBusinessHeadNewsAdapter(Context context, List<RegionalBusinessHeadNewsActivity.NewsItem> newsList) {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_regional_business_head_news, parent, false);
        return new NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        RegionalBusinessHeadNewsActivity.NewsItem news = newsList.get(position);
    ...
    public void updateNewsList(List<RegionalBusinessHeadNewsActivity.NewsItem> newNewsList) {
        this.newsList.clear();
