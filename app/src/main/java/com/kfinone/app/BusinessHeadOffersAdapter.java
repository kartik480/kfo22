...
public class BusinessHeadOffersAdapter extends RecyclerView.Adapter<BusinessHeadOffersAdapter.OfferViewHolder> {

    private List<BusinessHeadOffersActivity.OfferItem> offersList;
    private Context context;

    public BusinessHeadOffersAdapter(Context context, List<BusinessHeadOffersActivity.OfferItem> offersList) {
    ...
    public OfferViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business_head_offer, parent, false);
        return new OfferViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OfferViewHolder holder, int position) {
        BusinessHeadOffersActivity.OfferItem offer = offersList.get(position);
    ...
    public void updateOffersList(List<BusinessHeadOffersActivity.OfferItem> newOffersList) {
