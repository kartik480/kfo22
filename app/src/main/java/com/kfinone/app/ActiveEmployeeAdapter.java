...
public class ActiveEmployeeAdapter extends RecyclerView.Adapter<ActiveEmployeeAdapter.ViewHolder> {
    private static final String TAG = "ActiveEmployeeAdapter";
    private List<ManagingDirectorActiveEmpListActivity.ActiveEmployee> employees;
    private Context context;

    public ActiveEmployeeAdapter(List<ManagingDirectorActiveEmpListActivity.ActiveEmployee> employees, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_active_employee, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ManagingDirectorActiveEmpListActivity.ActiveEmployee employee = employees.get(position);
        
        // Set the employee information in the requested format
        holder.nameLabel.setText("Name:");
        holder.nameValue.setText(employee.getFullName());
        
        holder.employeeIdLabel.setText("Employee ID:");
        holder.employeeIdValue.setText(employee.getEmployeeNo());
        
        holder.phoneLabel.setText("Phone:");
        holder.phoneValue.setText(employee.getMobile());
        
        holder.emailLabel.setText("Email:");
        holder.emailValue.setText(employee.getEmail());
        
        holder.manageIconsLabel.setText("Manage Icons:");
        holder.manageIconsValue.setText(formatManageIcons(employee.getManageIcons()));
        
        // Set click listener for view button
        holder.viewButton.setOnClickListener(v -> showUserDetails(employee));
    }

    private String formatManageIcons(String manageIcons) {
        if (manageIcons == null || manageIcons.isEmpty() || manageIcons.equals("null")) {
            return "None";
        }
        
        // Split by comma and format nicely
        String[] icons = manageIcons.split(",");
        StringBuilder formatted = new StringBuilder();
        
        for (int i = 0; i < icons.length; i++) {
            if (i > 0) formatted.append(", ");
            formatted.append(icons[i].trim());
        }
    ...
    private void showUserDetails(ManagingDirectorActiveEmpListActivity.ActiveEmployee employee) {
        // Fetch detailed user information from server
        fetchUserDetails(employee.getId());
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView nameLabel, nameValue;
        TextView employeeIdLabel, employeeIdValue;
        TextView phoneLabel, phoneValue;
        TextView emailLabel, emailValue;
        TextView manageIconsLabel, manageIconsValue;
        Button viewButton;
        ...
        ViewHolder(View itemView) {
            ...
            employeeIdLabel = itemView.findViewById(R.id.employeeIdLabel);
            employeeIdValue = itemView.findViewById(R.id.employeeIdValue);
            phoneLabel = itemView.findViewById(R.id.phoneLabel);
            ...
            manageIconsLabel = itemView.findViewById(R.id.manageIconsLabel);
            manageIconsValue = itemView.findViewById(R.id.manageIconsValue);
