...
public class BusinessHeadTypeOfLoanActivity extends AppCompatActivity {

    private static final String TAG = "BusinessHeadTypeOfLoanActivity";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<VendorBank> adapter = new ArrayAdapter<VendorBank>(BusinessHeadTypeOfLoanActivity.this,
                        ...
                        Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error parsing vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVendorBanks();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<LoanType> adapter = new ArrayAdapter<LoanType>(BusinessHeadTypeOfLoanActivity.this,
                        ...
                        Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error parsing loan types - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackLoanTypes();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error parsing videos - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVideos();
                    }
                }
            },
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(BusinessHeadTypeOfLoanActivity.this, "Error loading videos - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVideos();
                }
            });
