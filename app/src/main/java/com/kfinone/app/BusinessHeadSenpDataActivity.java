...
public class BusinessHeadSenpDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "BHSenpData";
    ...
    private void initializeViews() {
        ...
        // Update title for Business Head SENP Data
        titleText.setText("Business Head SENP List");
        welcomeText.setText("Business Head SENP List");
        descriptionText.setText("Manage and filter SENP employee data for Business Head operations");
    }
