...
public class ManagingDirectorTrainingVideoActivity extends AppCompatActivity {

    private static final String TAG = "ManagingDirectorTrainingVideoActivity";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<VideoCategory> adapter = new ArrayAdapter<VideoCategory>(ManagingDirectorTrainingVideoActivity.this,
                        ...
                        Toast.makeText(ManagingDirectorTrainingVideoActivity.this, "Error parsing video categories - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ManagingDirectorTrainingVideoActivity.this, "Error loading video categories - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVideoCategories();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        Toast.makeText(ManagingDirectorTrainingVideoActivity.this, "Error parsing training videos - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ManagingDirectorTrainingVideoActivity.this, "Error loading training videos - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackTrainingVideos();
                }
            });
