...
public class RegionalBusinessHeadTrainingActivity extends AppCompatActivity {

    private static final String TAG = "RegionalBusinessHeadTrainingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regional_business_head_training);
    ...
    private void initializeViews() {
        ...
        if (titleText != null) {
            titleText.setText("Regional Business Head Training Center");
        }
    ...
    private void setupClickListeners() {
        ...
        typeOfLoanBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadTypeOfLoanActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        trainingVideoBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadTrainingVideoActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        profileBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadProfileActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
        ...
        policyBox.setOnClickListener(v -> {
            ...
            intent.putExtra("SOURCE_PANEL", "REGIONAL_BUSINESS_HEAD_TRAINING");
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        offersBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadOffersActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        newsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadNewsActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        policyImagesBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, RegionalBusinessHeadPolicyImagesActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
    }
