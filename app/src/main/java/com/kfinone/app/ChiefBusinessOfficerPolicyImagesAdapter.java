...
public class ChiefBusinessOfficerPolicyImagesAdapter extends RecyclerView.Adapter<ChiefBusinessOfficerPolicyImagesAdapter.PolicyImageViewHolder> {

    private List<ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem> policyImagesList;
    private Context context;

    public ChiefBusinessOfficerPolicyImagesAdapter(Context context, List<ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem> policyImagesList) {
    ...
    public PolicyImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chief_business_officer_policy_images, parent, false);
        return new PolicyImageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PolicyImageViewHolder holder, int position) {
        ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem policyImage = policyImagesList.get(position);
    ...
    public void updatePolicyImagesList(List<ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem> newPolicyImagesList) {
