...
public class DirectorTrainingVideoActivity extends AppCompatActivity {

    private static final String TAG = "DirectorTrainingVideoActivity";
    ...
    private List<TrainingVideoItem> videoList;
    ...
    private void setupClickListeners() {
        ...
        videoListView.setOnItemClickListener((parent, view, position, id) -> {
            TrainingVideoItem video = videoList.get(position);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<VideoCategory> adapter = new ArrayAdapter<VideoCategory>(DirectorTrainingVideoActivity.this,
                        ...
                        Toast.makeText(DirectorTrainingVideoActivity.this, "Error parsing video categories - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(DirectorTrainingVideoActivity.this, "Error loading video categories - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVideoCategories();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            videoList.add(new TrainingVideoItem(name, category, videoUrl));
                        }
                        ...
                        Toast.makeText(DirectorTrainingVideoActivity.this, "Error parsing training videos - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(DirectorTrainingVideoActivity.this, "Error loading training videos - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackTrainingVideos();
                }
            });
    ...
    public static class TrainingVideoItem {
        private String name;
        private String category;
        private String videoUrl;

        public TrainingVideoItem(String name, String category, String videoUrl) {
            this.name = name;
