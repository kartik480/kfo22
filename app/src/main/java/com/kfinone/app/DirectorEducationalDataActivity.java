...
public class DirectorEducationalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "DirectorEducationalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Educational Data
        titleText.setText("Database Educational List");
        welcomeText.setText("Database Educational List");
        descriptionText.setText("Manage and filter educational employee data with comprehensive search capabilities");
    }
