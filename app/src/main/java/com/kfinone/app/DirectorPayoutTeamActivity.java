...
public class DirectorPayoutTeamActivity extends AppCompatActivity {
    private static final String TAG = "DirectorPayoutTeamActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_director_payout_team);
    ...
    private void goBack() {
        Intent intent = new Intent(this, DirectorPayoutPanelActivity.class);
