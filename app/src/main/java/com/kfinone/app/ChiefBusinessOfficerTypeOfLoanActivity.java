...
public class ChiefBusinessOfficerTypeOfLoanActivity extends AppCompatActivity {

    private static final String TAG = "ChiefBusinessOfficerTypeOfLoanActivity";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<VendorBank> adapter = new ArrayAdapter<VendorBank>(ChiefBusinessOfficerTypeOfLoanActivity.this,
                        ...
                        Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error parsing vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVendorBanks();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<LoanType> adapter = new ArrayAdapter<LoanType>(ChiefBusinessOfficerTypeOfLoanActivity.this,
                        ...
                        Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error parsing loan types - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackLoanTypes();
                }
            });
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        if (success) {
                            ...
                            Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Loaded " + videoList.size() + " videos", Toast.LENGTH_SHORT).show();
                            
                        } else {
                            String message = response.getString("message");
                            Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "API Error: " + message, Toast.LENGTH_SHORT).show();
                            loadFallbackVideos();
                        }
                        
                    } catch (JSONException e) {
                        Log.e(TAG, "Error parsing videos JSON", e);
                        Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error parsing videos - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVideos();
                    }
                }
            },
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ChiefBusinessOfficerTypeOfLoanActivity.this, "Error loading videos - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVideos();
                }
            });
