...
public class BusinessHeadDatabaseActivity extends AppCompatActivity {

    private static final String TAG = "BHDatabase";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_head_database);
    ...
    private void setupClickListeners() {
        ...
        mySalDataCard.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, BusinessHeadSalDataActivity.class);
        ...
        mySenpDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, BusinessHeadSenpDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        mySepDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, BusinessHeadSepDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        myNriDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, BusinessHeadNriDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        myEducationalDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, BusinessHeadEducationalDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
