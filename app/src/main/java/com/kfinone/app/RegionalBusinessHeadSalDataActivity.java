...
public class RegionalBusinessHeadSalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "RBHSalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Regional Business Head
        titleText.setText("Regional Business Head Salaried List");
        welcomeText.setText("Regional Business Head Salaried List");
        descriptionText.setText("Manage and filter salaried employee data for Regional Business Head operations");
    }
