...
public class BusinessHeadNriDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "BHNriData";
    ...
    private void initializeViews() {
        ...
        // Update title for Business Head NRI Data
        titleText.setText("Business Head NRI List");
        welcomeText.setText("Business Head NRI List");
        descriptionText.setText("Manage and filter NRI employee data for Business Head operations");
    }
