...
public class BusinessHeadMyPortfolioActivity extends AppCompatActivity implements RBHPortfolioAdapter.OnPortfolioActionListener {

    private static final String TAG = "BusinessHeadMyPortfolio";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_head_my_portfolio);
    ...
    private void loadMyPortfolioData() {
