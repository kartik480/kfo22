...
public class ChiefBusinessOfficerSalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "CBOSalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Chief Business Officer
        titleText.setText("Chief Business Officer Salaried List");
        welcomeText.setText("Chief Business Officer Salaried List");
        descriptionText.setText("Manage and filter salaried employee data for Chief Business Officer operations");
    }
