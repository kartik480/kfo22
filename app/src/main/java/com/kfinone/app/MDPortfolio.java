...
public class MDPortfolio {
    ...
    public MDPortfolio(String id, String customerName, String companyName, String phoneNumber,
                       ...
                       String status, String createdAt, String updatedAt, String creatorUsername,
                       String creatorFirstName, String creatorLastName, String creatorDesignationId,
                       String creatorDesignationName, String creatorFullName) {
        this.id = id;
