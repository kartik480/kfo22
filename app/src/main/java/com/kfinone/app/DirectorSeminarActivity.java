...
public class DirectorSeminarActivity extends AppCompatActivity {

    private static final String TAG = "DirectorSeminar";
    ...
    private List<SeminarItem> seminarList;
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DirectorSeminarActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVendorBanks();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DirectorSeminarActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackLoanTypes();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                SeminarItem item = new SeminarItem(
                            ...
                            Toast.makeText(DirectorSeminarActivity.this, "Error parsing seminars", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DirectorSeminarActivity.this, "Error loading seminars - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackSeminars();
                    }
                });
    ...
    private void applyFilters() {
        ...
        List<SeminarItem> filteredList = new ArrayList<>();
        
        for (SeminarItem seminar : seminarList) {
    ...
    public static class SeminarItem {
        ...
        public SeminarItem(String name, String vendorBank, String loanType, String videoUrl) {
            this.name = name;
