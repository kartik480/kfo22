...
public class BusinessHeadOffersActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView offersRecyclerView;
    private BusinessHeadOffersAdapter offersAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_head_offers);
    ...
    private void setupRecyclerView() {
        offersAdapter = new BusinessHeadOffersAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<BusinessHeadOffersActivity.OfferItem> offersList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                offersList.add(new BusinessHeadOffersActivity.OfferItem(id, name, image, status));
                            } else {
