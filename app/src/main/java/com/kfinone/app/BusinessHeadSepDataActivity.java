...
public class BusinessHeadSepDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "BHSepData";
    ...
    private void initializeViews() {
        ...
        // Update title for Business Head SEP Data
        titleText.setText("Business Head SEP List");
        welcomeText.setText("Business Head SEP List");
        descriptionText.setText("Manage and filter SEP employee data for Business Head operations");
    }
