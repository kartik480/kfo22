...
public class RegionalBusinessHeadSenpDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "RBHSenpData";
    ...
    private void initializeViews() {
        ...
        // Update title for Regional Business Head SENP Data
        titleText.setText("Regional Business Head SENP List");
        welcomeText.setText("Regional Business Head SENP List");
        descriptionText.setText("Manage and filter SENP employee data for Regional Business Head operations");
    }
