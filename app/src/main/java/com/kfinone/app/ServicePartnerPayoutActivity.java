...
public class ServicePartnerPayoutActivity extends AppCompatActivity {
    private static final String TAG = "ServicePartnerPayoutActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_partner_payout);
    ...
    private void initializeViews() {
        ...
        titleText.setText("Service/Partner Payout");
                        ...
                        runOnUiThread(() -> {
                            try {
                                ArrayAdapter<VendorBank> adapter = new ArrayAdapter<>(
                                    ServicePartnerPayoutActivity.this,
    ...
    private void loadPayoutList() {
        executor.execute(() -> {
            try {
                String urlString = BASE_URL + "get_service_partner_payouts.php";
                URL url = new URL(urlString);
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                connection.setRequestMethod("GET");
                connection.setConnectTimeout(10000);
                ...
                runOnUiThread(() -> {
                    try {
                        // Add sample data
                        allPayoutItems.clear();
                        allPayoutItems.add(new PayoutItem(1, 0, "Service/Partner Payout", "HDFC Bank", "Personal Loan", "Service", "₹50,000"));
                        allPayoutItems.add(new PayoutItem(2, 0, "Service/Partner Payout", "ICICI Bank", "Home Loan", "Partner", "₹5,00,000"));
                        allPayoutItems.add(new PayoutItem(3, 0, "Service/Partner Payout", "State Bank of India", "Business Loan", "Service", "₹10,00,000"));
