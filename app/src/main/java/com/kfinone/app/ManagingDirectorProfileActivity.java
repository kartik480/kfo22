...
public class ManagingDirectorProfileActivity extends AppCompatActivity {

    private static final String TAG = "ManagingDirectorProfile";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            android.widget.ArrayAdapter<String> adapter = new android.widget.ArrayAdapter<>(
                                    ManagingDirectorProfileActivity.this,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorProfileActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVendorBanks();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorProfileActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackLoanTypes();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            Toast.makeText(ManagingDirectorProfileActivity.this, "Error parsing profiles", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorProfileActivity.this, "Error loading profiles - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackProfiles();
                    }
                });
