...
public class DirectorPolicyImagesAdapter extends RecyclerView.Adapter<DirectorPolicyImagesAdapter.PolicyImageViewHolder> {

    private List<DirectorPolicyImagesActivity.PolicyImageItem> policyImagesList;
    private Context context;

    public DirectorPolicyImagesAdapter(Context context, List<DirectorPolicyImagesActivity.PolicyImageItem> policyImagesList) {
    ...
    public PolicyImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_director_policy_images, parent, false);
        return new PolicyImageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PolicyImageViewHolder holder, int position) {
        DirectorPolicyImagesActivity.PolicyImageItem policyImage = policyImagesList.get(position);
    ...
    public void updatePolicyImagesList(List<DirectorPolicyImagesActivity.PolicyImageItem> newPolicyImagesList) {
