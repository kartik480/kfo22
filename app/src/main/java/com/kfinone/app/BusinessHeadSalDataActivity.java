...
public class BusinessHeadSalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "BHSalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Business Head
        titleText.setText("Business Head Salaried List");
        welcomeText.setText("Business Head Salaried List");
        descriptionText.setText("Manage and filter salaried employee data for Business Head operations");
    }
