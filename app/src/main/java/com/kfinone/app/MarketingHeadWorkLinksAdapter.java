...
public class MarketingHeadWorkLinksAdapter extends RecyclerView.Adapter<MarketingHeadWorkLinksAdapter.ViewHolder> {
    private List<MarketingHeadWorkIcon> icons;
    private Context context;

    public MarketingHeadWorkLinksAdapter(Context context, List<MarketingHeadWorkIcon> icons) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_marketing_head_work_link_icon, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MarketingHeadWorkIcon icon = icons.get(position);
    ...
    public void updateIcons(List<MarketingHeadWorkIcon> newIcons) {
        this.icons = newIcons;
