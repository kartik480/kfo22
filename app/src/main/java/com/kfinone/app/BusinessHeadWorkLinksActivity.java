...
public class BusinessHeadWorkLinksActivity extends AppCompatActivity {
    private static final String TAG = "BusinessHeadWorkLinks";
    ...
    private BusinessHeadWorkLinksAdapter adapter;
    private List<BusinessHeadWorkIcon> iconList = new ArrayList<>();
    ...
    private void setupRecyclerView() {
        adapter = new BusinessHeadWorkLinksAdapter(this, iconList);
    ...
    private void loadWorkIcons() {
        ...
        String url = API_BASE_URL + "/get_business_head_work_icons.php";
        ...
        try {
            ...
            if ("success".equals(status)) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    BusinessHeadWorkIcon icon = new BusinessHeadWorkIcon(
