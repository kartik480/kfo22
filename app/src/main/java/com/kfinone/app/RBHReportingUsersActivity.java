...
public class RBHReportingUsersActivity extends AppCompatActivity {
    
    private static final String TAG = "RBHReportingUsers";
    ...
    private RBHReportingUsersAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rbh_reporting_users);
    ...
    private void initializeViews() {
        ...
        adapter = new RBHReportingUsersAdapter(reportingUsers, this);
