...
public class ManagingDirectorPolicyImagesAdapter extends RecyclerView.Adapter<ManagingDirectorPolicyImagesAdapter.PolicyImageViewHolder> {

    private List<ManagingDirectorPolicyImagesActivity.PolicyImageItem> policyImagesList;
    private Context context;

    public ManagingDirectorPolicyImagesAdapter(Context context, List<ManagingDirectorPolicyImagesActivity.PolicyImageItem> policyImagesList) {
    ...
    public PolicyImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_managing_director_policy_images, parent, false);
        return new PolicyImageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PolicyImageViewHolder holder, int position) {
        ManagingDirectorPolicyImagesActivity.PolicyImageItem policyImage = policyImagesList.get(position);
    ...
    public void updatePolicyImagesList(List<ManagingDirectorPolicyImagesActivity.PolicyImageItem> newPolicyImagesList) {
