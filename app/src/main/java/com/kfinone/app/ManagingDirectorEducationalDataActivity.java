...
public class ManagingDirectorEducationalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "MDEducationalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Managing Director Educational Data
        titleText.setText("Managing Director Educational List");
        welcomeText.setText("Managing Director Educational List");
        descriptionText.setText("Manage and filter educational employee data for Managing Director operations");
    }
