...
public class ChiefBusinessOfficerSenpDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "CBOSenpData";
    ...
    private void initializeViews() {
        ...
        // Update title for Chief Business Officer SENP Data
        titleText.setText("Chief Business Officer SENP List");
        welcomeText.setText("Chief Business Officer SENP List");
        descriptionText.setText("Manage and filter SENP employee data for Chief Business Officer operations");
    }
