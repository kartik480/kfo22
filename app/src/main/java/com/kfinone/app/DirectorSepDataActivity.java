...
public class DirectorSepDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "DirectorSepData";
    ...
    private void initializeViews() {
        ...
        // Update title for SEP Data
        titleText.setText("Database SEP List");
        welcomeText.setText("Database SEP List");
        descriptionText.setText("Manage and filter SEP employee data with comprehensive search capabilities");
    }
