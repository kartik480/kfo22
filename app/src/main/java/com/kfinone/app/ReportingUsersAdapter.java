...
public class ReportingUsersAdapter extends RecyclerView.Adapter<ReportingUsersAdapter.ViewHolder> {
    
    private List<CBOReportingUsersActivity.ReportingUser> users;
    private Context context;
    
    public ReportingUsersAdapter(List<CBOReportingUsersActivity.ReportingUser> users, Context context) {
        this.users = users;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CBOReportingUsersActivity.ReportingUser user = users.get(position);
    ...
    public void updateData(List<CBOReportingUsersActivity.ReportingUser> newUsers) {
        this.users.clear();
