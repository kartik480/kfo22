...
public class ChiefBusinessOfficerSepDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "CBOSepData";
    ...
    private void initializeViews() {
        ...
        // Update title for Chief Business Officer SEP Data
        titleText.setText("Chief Business Officer SEP List");
        welcomeText.setText("Chief Business Officer SEP List");
        descriptionText.setText("Manage and filter SEP employee data for Chief Business Officer operations");
    }
