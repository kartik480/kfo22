...
public class MarketingHeadWorkLinksActivity extends AppCompatActivity {
    private static final String TAG = "MarketingHeadWorkLinks";
    ...
    private MarketingHeadWorkLinksAdapter adapter;
    private List<MarketingHeadWorkIcon> iconList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketing_head_work_links);
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Work Links");
        }
    }

    private void setupRecyclerView() {
        adapter = new MarketingHeadWorkLinksAdapter(this, iconList);
    ...
    private void loadWorkIcons() {
        ...
        String url = API_BASE_URL + "/get_marketing_head_work_icons.php";
        ...
        try {
            ...
            if ("success".equals(status)) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    MarketingHeadWorkIcon icon = new MarketingHeadWorkIcon(
    ...
    public void onBackPressed() {
        ...
        Intent backIntent = new Intent(MarketingHeadWorkLinksActivity.this, MarketingHeadPanelActivity.class);
    ...
    private void showAboutDialog() {
        ...
        builder.setTitle("About Work Links");
        builder.setMessage("Work Links Panel v1.0\n\n" +
                "This panel provides access to various work-related links and resources including:\n" +
