...
public class ChiefBusinessOfficerTrainingActivity extends AppCompatActivity {

    private static final String TAG = "ChiefBusinessOfficerTrainingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chief_business_officer_training);
    ...
    private void initializeViews() {
        ...
        if (titleText != null) {
            titleText.setText("Chief Business Officer Training Center");
        }
    ...
    private void setupClickListeners() {
        ...
        typeOfLoanBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerTypeOfLoanActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        trainingVideoBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerTrainingVideoActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        profileBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerProfileActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        seminarsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerSeminarActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
        ...
        policyBox.setOnClickListener(v -> {
            ...
            intent.putExtra("SOURCE_PANEL", "CHIEF_BUSINESS_OFFICER_TRAINING");
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        offersBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerOffersActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        newsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerNewsActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        policyImagesBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ChiefBusinessOfficerPolicyImagesActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
    }
