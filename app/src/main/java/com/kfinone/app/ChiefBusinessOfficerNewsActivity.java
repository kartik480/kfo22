...
public class ChiefBusinessOfficerNewsActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView newsRecyclerView;
    private ChiefBusinessOfficerNewsAdapter newsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chief_business_officer_news);
    ...
    private void setupRecyclerView() {
        newsAdapter = new ChiefBusinessOfficerNewsAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<ChiefBusinessOfficerNewsActivity.NewsItem> newsList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                newsList.add(new ChiefBusinessOfficerNewsActivity.NewsItem(id, name, image, status));
                            } else {
