...
public class RegionalBusinessHeadPolicyImagesActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView policyImagesRecyclerView;
    private RegionalBusinessHeadPolicyImagesAdapter policyImagesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regional_business_head_policy_images);
    ...
    private void setupRecyclerView() {
        policyImagesAdapter = new RegionalBusinessHeadPolicyImagesAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<RegionalBusinessHeadPolicyImagesActivity.PolicyImageItem> policyImagesList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                policyImagesList.add(new RegionalBusinessHeadPolicyImagesActivity.PolicyImageItem(id, name, image, status));
                            } else {
