...
public class ManagingDirectorSeminarActivity extends AppCompatActivity {

    private static final String TAG = "ManagingDirectorSeminar";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            android.widget.ArrayAdapter<String> adapter = new android.widget.ArrayAdapter<>(
                                    ManagingDirectorSeminarActivity.this,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorSeminarActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVendorBanks();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorSeminarActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackLoanTypes();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            Toast.makeText(ManagingDirectorSeminarActivity.this, "Error parsing seminars", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManagingDirectorSeminarActivity.this, "Error loading seminars - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackSeminars();
                    }
                });
