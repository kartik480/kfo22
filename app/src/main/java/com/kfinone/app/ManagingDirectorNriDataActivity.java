...
public class ManagingDirectorNriDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "MDNriData";
    ...
    private void initializeViews() {
        ...
        // Update title for Managing Director NRI Data
        titleText.setText("Managing Director NRI List");
        welcomeText.setText("Managing Director NRI List");
        descriptionText.setText("Manage and filter NRI employee data for Managing Director operations");
    }
