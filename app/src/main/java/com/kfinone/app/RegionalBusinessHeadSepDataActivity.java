...
public class RegionalBusinessHeadSepDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "RBHSepData";
    ...
    private void initializeViews() {
        ...
        // Update title for Regional Business Head SEP Data
        titleText.setText("Regional Business Head SEP List");
        welcomeText.setText("Regional Business Head SEP List");
        descriptionText.setText("Manage and filter SEP employee data for Regional Business Head operations");
    }
