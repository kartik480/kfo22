...
public class DocCheckListActivity extends AppCompatActivity {

    private static final String TAG = "DocCheckListActivity";

    private RecyclerView documentRecyclerView;
    private DocumentAdapter documentAdapter;
    private List<DocumentItem> documentList;
    private List<DocumentItem> filteredList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_check_list);
    ...
    private void searchDocuments(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (DocumentItem document : documentList) {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (json.getString("status").equals("success")) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            Toast.makeText(DocCheckListActivity.this, 
    ...
    // Document Item data class
    public static class DocumentItem {
        private String name;
        private String documentName;
        private String downloadUrl;

        public DocumentItem(String name, String documentName, String downloadUrl) {
            this.name = name;
