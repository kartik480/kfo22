...
public class ChiefBusinessOfficerTrainingVideoActivity extends AppCompatActivity {

    private static final String TAG = "ChiefBusinessOfficerTrainingVideoActivity";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        ArrayAdapter<VideoCategory> adapter = new ArrayAdapter<VideoCategory>(ChiefBusinessOfficerTrainingVideoActivity.this,
                        ...
                        Toast.makeText(ChiefBusinessOfficerTrainingVideoActivity.this, "Error parsing video categories - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ChiefBusinessOfficerTrainingVideoActivity.this, "Error loading video categories - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackVideoCategories();
                }
            });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
            new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        Toast.makeText(ChiefBusinessOfficerTrainingVideoActivity.this, "Error parsing training videos - using fallback data", Toast.LENGTH_SHORT).show();
            ...
            new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(ChiefBusinessOfficerTrainingVideoActivity.this, "Error loading training videos - using fallback data", Toast.LENGTH_SHORT).show();
                    loadFallbackTrainingVideos();
                }
            });
