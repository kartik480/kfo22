...
public class ManagingDirectorNewsActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView newsRecyclerView;
    private ManagingDirectorNewsAdapter newsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managing_director_news);
    ...
    private void setupRecyclerView() {
        newsAdapter = new ManagingDirectorNewsAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<ManagingDirectorNewsActivity.NewsItem> newsList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                newsList.add(new ManagingDirectorNewsActivity.NewsItem(id, name, image, status));
                            } else {
