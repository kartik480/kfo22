...
public class SuperAdminBHEmpMasterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_super_admin_bh_emp_master);
        ...
        activeEmpListCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SuperAdminBHEmpMasterActivity.this, CBOActiveEmpListActivity.class);
                // Pass user data
                if (firstName != null) intent.putExtra("FIRST_NAME", firstName);
                if (lastName != null) intent.putExtra("LAST_NAME", lastName);
                if (fullName != null) intent.putExtra("USERNAME", fullName);
                if (userId != null) intent.putExtra("USER_ID", userId);
                intent.putExtra("SOURCE_PANEL", "BH_EMP_MASTER_PANEL");
        ...
        inactiveEmpListCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SuperAdminBHEmpMasterActivity.this, CBOInactiveEmpListActivity.class);
                // Pass user data
                if (firstName != null) intent.putExtra("FIRST_NAME", firstName);
                if (lastName != null) intent.putExtra("LAST_NAME", lastName);
                if (fullName != null) intent.putExtra("USERNAME", fullName);
