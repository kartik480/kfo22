...
public class BusinessHeadNewsActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView newsRecyclerView;
    private BusinessHeadNewsAdapter newsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_head_news);
    ...
    private void setupRecyclerView() {
        newsAdapter = new BusinessHeadNewsAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<BusinessHeadNewsActivity.NewsItem> newsList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                newsList.add(new BusinessHeadNewsActivity.NewsItem(id, name, image, status));
                            } else {
