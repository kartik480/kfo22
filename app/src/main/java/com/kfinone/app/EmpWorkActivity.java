...
public class EmpWorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addIconsCard.setOnClickListener(v -> {
            Intent intent = new Intent(EmpWorkActivity.this, AddWorkIconsActivity.class);
            startActivity(intent);
        });

        // Setup Team Links card click
        teamLinksCard.setOnClickListener(v -> {
            Intent intent = new Intent(EmpWorkActivity.this, TeamLinksActivity.class);
            startActivity(intent);
        });
    }
} 
