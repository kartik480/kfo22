...
public class RegionalBusinessHeadOffersActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView offersRecyclerView;
    private RegionalBusinessHeadOffersAdapter offersAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regional_business_head_offers);
    ...
    private void setupRecyclerView() {
        offersAdapter = new RegionalBusinessHeadOffersAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<RegionalBusinessHeadOffersActivity.OfferItem> offersList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                offersList.add(new RegionalBusinessHeadOffersActivity.OfferItem(id, name, image, status));
                            } else {
