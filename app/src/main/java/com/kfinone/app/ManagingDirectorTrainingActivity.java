...
public class ManagingDirectorTrainingActivity extends AppCompatActivity {

    private static final String TAG = "ManagingDirectorTrainingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managing_director_training);
    ...
    private void initializeViews() {
        ...
        if (titleText != null) {
            titleText.setText("Managing Director Training Center");
        }
    ...
    private void setupClickListeners() {
        ...
        typeOfLoanBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorTypeOfLoanActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        trainingVideoBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorTrainingVideoActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        profileBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorProfileActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        seminarsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorSeminarActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
        ...
        offersBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorOffersActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        newsBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorNewsActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });

        policyImagesBox.setOnClickListener(v -> {
            Intent intent = new Intent(this, ManagingDirectorPolicyImagesActivity.class);
            passUserDataToIntent(intent);
            startActivity(intent);
        });
    }
