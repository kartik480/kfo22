...
public class ManagingDirectorWorkLinksAdapter extends RecyclerView.Adapter<ManagingDirectorWorkLinksAdapter.ViewHolder> {
    private List<ManagingDirectorWorkIcon> icons;
    private Context context;

    public ManagingDirectorWorkLinksAdapter(Context context, List<ManagingDirectorWorkIcon> icons) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_managing_director_work_link_icon, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ManagingDirectorWorkIcon icon = icons.get(position);
    ...
    public void updateIcons(List<ManagingDirectorWorkIcon> newIcons) {
        this.icons = newIcons;
