...
public class RegionalBusinessHeadDatabaseActivity extends AppCompatActivity {

    private static final String TAG = "RBHDatabase";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regional_business_head_database);
    ...
    private void setupClickListeners() {
        ...
        mySalDataCard.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, RegionalBusinessHeadSalDataActivity.class);
        ...
        mySenpDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, RegionalBusinessHeadSenpDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        mySepDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, RegionalBusinessHeadSepDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        myNriDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, RegionalBusinessHeadNriDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
        ...
        myEducationalDataCard.setOnClickListener(v -> {
            ...
            // Intent intent = new Intent(this, RegionalBusinessHeadEducationalDataActivity.class);
            // passUserDataToIntent(intent);
            // startActivity(intent);
        });
