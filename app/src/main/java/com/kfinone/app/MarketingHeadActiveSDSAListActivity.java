...
public class MarketingHeadActiveSDSAListActivity extends AppCompatActivity {
    private static final String TAG = "MarketingHeadActiveSDSA";
    ...
    // API URL
    private static final String API_URL = "https://emp.kfinone.com/mobile/api/get_all_sdsa_users.php";
    
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_marketing_head_active_sdsa_list);
        ...
        // Debug logging
        Log.d(TAG, "MarketingHeadActiveSDSAListActivity received USER_ID: " + userId);
        Log.d(TAG, "MarketingHeadActiveSDSAListActivity received USERNAME: " + username);
        ...
        findViewById(R.id.refreshButton).setOnClickListener(v -> loadSDSUsers());
    ...
    private void updateWelcomeText() {
        if (firstName != null && !firstName.isEmpty()) {
            welcomeText.setText("Welcome, " + firstName + " - Active SDSA List");
        } else {
            welcomeText.setText("Welcome, Marketing Head - Active SDSA List");
        }
    }
    
    private void loadSDSUsers() {
        showProgress(true);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            // Update count
                            totalCountText.setText("Total SDSA Users: " + count);
                            ...
                            Log.d(TAG, "Successfully loaded " + count + " SDSA users");
                            
                        } else {
                            showError("Failed to load SDSA users: " + message);
                        }
    ...
    private void showEmptyState() {
        ...
        if (emptyText != null) {
            ...
            emptyText.setText("No SDSA users found in the system");
        }
    }
    ...
    private void showHelpDialog() {
        ...
        builder.setTitle("Help - Active SDSA List");
        builder.setMessage("This panel displays all SDSA users in the system.\n\n" +
                "Features:\n" +
                "• View all SDSA users with their details\n" +
    ...
    private void showAboutDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("About Active SDSA List");
        builder.setMessage("Active SDSA List Panel v1.0\n\n" +
                "This panel provides comprehensive access to all SDSA users including:\n" +
