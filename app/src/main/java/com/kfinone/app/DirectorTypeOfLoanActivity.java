...
public class DirectorTypeOfLoanActivity extends AppCompatActivity {
    ...
    private void loadFallbackVideos() {
        videoList.clear();
        videoList.add(new VideoItem("Personal Loan Basics", "HDFC Bank", "Personal Loan", "https://example.com/video1.mp4"));
        videoList.add(new VideoItem("Home Loan Process", "ICICI Bank", "Home Loan", "https://example.com/video2.mp4"));
        videoList.add(new VideoItem("Car Loan Guide", "SBI Bank", "Car Loan", "https://example.com/video3.mp4"));
        videoList.add(new VideoItem("Business Loan Overview", "Axis Bank", "Business Loan", "https://example.com/video4.mp4"));
        videoList.add(new VideoItem("Education Loan Tips", "Kotak Bank", "Education Loan", "https://example.com/video5.mp4"));
