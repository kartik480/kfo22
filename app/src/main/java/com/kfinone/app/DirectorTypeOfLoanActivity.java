...
public class DirectorTypeOfLoanActivity extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            for (int i = 0; i < dataArray.length(); i++) {
                                ...
                                videoList.add(new VideoItem(id, videoName, videoImage, video, vendorBankId, loanTypeId, vendorBankName, loanType));
                            }
                            
                            videoAdapter.notifyDataSetChanged();
                            Toast.makeText(DirectorTypeOfLoanActivity.this, "Loaded " + videoList.size() + " videos", Toast.LENGTH_SHORT).show();
                            
                        } else {
                            String message = response.getString("message");
                            Toast.makeText(DirectorTypeOfLoanActivity.this, "API Error: " + message, Toast.LENGTH_SHORT).show();
                            loadFallbackVideos();
                        }
    ...
    public static class VideoItem {
        ...
        public VideoItem(int id, String videoName, String videoImage, String video, int vendorBankId, int loanTypeId, String vendorBankName, String loanType) {
            this.id = id;
        ...
        public int getVendorBankId() { return vendorBankId; }
        ...
        public String getVendorBank() { return vendorBankName; }
        public String getVideoUrl() { return "https://emp.kfinone.com/backPanel/training/training_loan_type_video_api.php/" + video; }
    }
}
