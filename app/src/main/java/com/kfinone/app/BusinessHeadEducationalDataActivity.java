...
public class BusinessHeadEducationalDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "BHEducationalData";
    ...
    private void initializeViews() {
        ...
        // Update title for Business Head Educational Data
        titleText.setText("Business Head Educational List");
        welcomeText.setText("Business Head Educational List");
        descriptionText.setText("Manage and filter educational employee data for Business Head operations");
    }
