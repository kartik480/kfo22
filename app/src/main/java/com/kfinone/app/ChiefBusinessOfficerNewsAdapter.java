...
public class ChiefBusinessOfficerNewsAdapter extends RecyclerView.Adapter<ChiefBusinessOfficerNewsAdapter.NewsViewHolder> {

    private List<ChiefBusinessOfficerNewsActivity.NewsItem> newsList;
    private Context context;

    public ChiefBusinessOfficerNewsAdapter(Context context, List<ChiefBusinessOfficerNewsActivity.NewsItem> newsList) {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chief_business_officer_news, parent, false);
        return new NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        ChiefBusinessOfficerNewsActivity.NewsItem news = newsList.get(position);
    ...
    public void updateNewsList(List<ChiefBusinessOfficerNewsActivity.NewsItem> newNewsList) {
        this.newsList.clear();
