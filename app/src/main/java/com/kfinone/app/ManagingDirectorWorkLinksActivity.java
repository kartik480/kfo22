...
public class ManagingDirectorWorkLinksActivity extends AppCompatActivity {
    ...
    private ManagingDirectorWorkLinksAdapter adapter;
    private List<ManagingDirectorWorkIcon> iconList = new ArrayList<>();
    ...
    private void setupRecyclerView() {
        adapter = new ManagingDirectorWorkLinksAdapter(this, iconList);
    ...
    private void loadWorkIcons() {
        ...
        String url = API_BASE_URL + "/get_managing_director_work_icons.php";
        ...
        try {
            ...
            if ("success".equals(status)) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    ManagingDirectorWorkIcon icon = new ManagingDirectorWorkIcon(
