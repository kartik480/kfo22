...
public class DirectorNriDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "DirectorNriData";
    ...
    private void initializeViews() {
        ...
        // Update title for NRI Data
        titleText.setText("Database NRI List");
        welcomeText.setText("Database NRI List");
        descriptionText.setText("Manage and filter NRI employee data with comprehensive search capabilities");
    }
