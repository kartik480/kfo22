...
public class RegionalBusinessHeadNriDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "RBHNriData";
    ...
    private void initializeViews() {
        ...
        // Update title for Regional Business Head NRI Data
        titleText.setText("Regional Business Head NRI List");
        welcomeText.setText("Regional Business Head NRI List");
        descriptionText.setText("Manage and filter NRI employee data for Regional Business Head operations");
    }
