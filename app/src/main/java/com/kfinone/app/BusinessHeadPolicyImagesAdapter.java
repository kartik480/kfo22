...
public class BusinessHeadPolicyImagesAdapter extends RecyclerView.Adapter<BusinessHeadPolicyImagesAdapter.PolicyImageViewHolder> {

    private List<BusinessHeadPolicyImagesActivity.PolicyImageItem> policyImagesList;
    private Context context;

    public BusinessHeadPolicyImagesAdapter(Context context, List<BusinessHeadPolicyImagesActivity.PolicyImageItem> policyImagesList) {
    ...
    public PolicyImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business_head_policy_images, parent, false);
        return new PolicyImageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PolicyImageViewHolder holder, int position) {
        BusinessHeadPolicyImagesActivity.PolicyImageItem policyImage = policyImagesList.get(position);
    ...
    public void updatePolicyImagesList(List<BusinessHeadPolicyImagesActivity.PolicyImageItem> newPolicyImagesList) {
