...
public class DirectorSenpDataActivity extends AppCompatActivity implements SalariedListAdapter.OnSalariedActionClickListener {

    private static final String TAG = "DirectorSenpData";
    ...
    private void initializeViews() {
        ...
        // Update title for SENP Data
        titleText.setText("Database SENP List");
        welcomeText.setText("Database SENP List");
        descriptionText.setText("Manage and filter SENP employee data with comprehensive search capabilities");
    }
