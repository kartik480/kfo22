...
public class BusinessHeadSeminarActivity extends AppCompatActivity {

    private static final String TAG = "BusinessHeadSeminar";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            android.widget.ArrayAdapter<String> adapter = new android.widget.ArrayAdapter<>(
                                    BusinessHeadSeminarActivity.this,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(BusinessHeadSeminarActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVendorBanks();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(BusinessHeadSeminarActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackLoanTypes();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            Toast.makeText(BusinessHeadSeminarActivity.this, "Error parsing seminars", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(BusinessHeadSeminarActivity.this, "Error loading seminars - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackSeminars();
                    }
                });
