...
public class ManagingDirectorPolicyImagesActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView policyImagesRecyclerView;
    private ManagingDirectorPolicyImagesAdapter policyImagesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managing_director_policy_images);
    ...
    private void setupRecyclerView() {
        policyImagesAdapter = new ManagingDirectorPolicyImagesAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<ManagingDirectorPolicyImagesActivity.PolicyImageItem> policyImagesList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                policyImagesList.add(new ManagingDirectorPolicyImagesActivity.PolicyImageItem(id, name, image, status));
                            } else {
