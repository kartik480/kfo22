...
public class CBOPayoutTeamActivity extends AppCompatActivity {
    private static final String TAG = "CBOPayoutTeamActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cbo_payout_team);
    ...
    // PayoutType data class - REMOVED (now standalone class)
    
    // PayoutTypeAdapter for RecyclerView - REMOVED (now standalone class)
}
