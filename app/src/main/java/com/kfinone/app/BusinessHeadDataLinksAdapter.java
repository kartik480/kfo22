...
public class BusinessHeadDataLinksAdapter extends RecyclerView.Adapter<BusinessHeadDataLinksAdapter.ViewHolder> {
    private List<BusinessHeadDataIcon> icons;
    private Context context;

    public BusinessHeadDataLinksAdapter(Context context, List<BusinessHeadDataIcon> icons) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_business_head_data_link_icon, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BusinessHeadDataIcon icon = icons.get(position);
    ...
    public void updateIcons(List<BusinessHeadDataIcon> newIcons) {
        this.icons = newIcons;
