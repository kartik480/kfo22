...
public class ChiefBusinessOfficerOffersAdapter extends RecyclerView.Adapter<ChiefBusinessOfficerOffersAdapter.OfferViewHolder> {

    private List<ChiefBusinessOfficerOffersActivity.OfferItem> offersList;
    private Context context;

    public ChiefBusinessOfficerOffersAdapter(Context context, List<ChiefBusinessOfficerOffersActivity.OfferItem> offersList) {
    ...
    public OfferViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chief_business_officer_offer, parent, false);
        return new OfferViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OfferViewHolder holder, int position) {
        ChiefBusinessOfficerOffersActivity.OfferItem offer = offersList.get(position);
    ...
    public void updateOffersList(List<ChiefBusinessOfficerOffersActivity.OfferItem> newOffersList) {
