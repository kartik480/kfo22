...
public class ChiefBusinessOfficerOffersActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView offersRecyclerView;
    private ChiefBusinessOfficerOffersAdapter offersAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chief_business_officer_offers);
    ...
    private void setupRecyclerView() {
        offersAdapter = new ChiefBusinessOfficerOffersAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<ChiefBusinessOfficerOffersActivity.OfferItem> offersList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                offersList.add(new ChiefBusinessOfficerOffersActivity.OfferItem(id, name, image, status));
                            } else {
