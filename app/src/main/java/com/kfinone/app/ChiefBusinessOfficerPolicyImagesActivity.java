...
public class ChiefBusinessOfficerPolicyImagesActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView policyImagesRecyclerView;
    private ChiefBusinessOfficerPolicyImagesAdapter policyImagesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chief_business_officer_policy_images);
    ...
    private void setupRecyclerView() {
        policyImagesAdapter = new ChiefBusinessOfficerPolicyImagesAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem> policyImagesList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                policyImagesList.add(new ChiefBusinessOfficerPolicyImagesActivity.PolicyImageItem(id, name, image, status));
                            } else {
