...
public class MarketingHeadDataLinksAdapter extends RecyclerView.Adapter<MarketingHeadDataLinksAdapter.ViewHolder> {
    private List<MarketingHeadDataIcon> icons;
    private Context context;

    public MarketingHeadDataLinksAdapter(Context context, List<MarketingHeadDataIcon> icons) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_marketing_head_data_link_icon, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MarketingHeadDataIcon icon = icons.get(position);
    ...
    public void updateIcons(List<MarketingHeadDataIcon> newIcons) {
        this.icons = newIcons;
