...
public class RegionalBusinessHeadNewsActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView newsRecyclerView;
    private RegionalBusinessHeadNewsAdapter newsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regional_business_head_news);
    ...
    private void setupRecyclerView() {
        newsAdapter = new RegionalBusinessHeadNewsAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<RegionalBusinessHeadNewsActivity.NewsItem> newsList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                newsList.add(new RegionalBusinessHeadNewsActivity.NewsItem(id, name, image, status));
                            } else {
