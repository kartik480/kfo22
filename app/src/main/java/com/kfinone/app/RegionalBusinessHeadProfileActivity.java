...
public class RegionalBusinessHeadProfileActivity extends AppCompatActivity {

    private static final String TAG = "RegionalBusinessHeadProfile";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            android.widget.ArrayAdapter<String> adapter = new android.widget.ArrayAdapter<>(
                                    RegionalBusinessHeadProfileActivity.this,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RegionalBusinessHeadProfileActivity.this, "Error loading vendor banks - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackVendorBanks();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RegionalBusinessHeadProfileActivity.this, "Error loading loan types - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackLoanTypes();
                    }
                });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            Toast.makeText(RegionalBusinessHeadProfileActivity.this, "Error parsing profiles", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RegionalBusinessHeadProfileActivity.this, "Error loading profiles - using fallback data", Toast.LENGTH_SHORT).show();
                        loadFallbackProfiles();
                    }
                });
