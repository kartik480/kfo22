...
public class BusinessHeadPolicyActivity extends AppCompatActivity {

    private static final String TAG = "BusinessHeadPolicyActivity";
    ...
    private List<PolicyActivity.PolicyItem> filteredList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "BusinessHeadPolicyActivity onCreate started");
        
        try {
            setContentView(R.layout.activity_business_head_policy);
            Log.d(TAG, "BusinessHeadPolicyActivity layout set successfully");
            ...
            Toast.makeText(this, "Business Head Policy panel loaded successfully!", Toast.LENGTH_SHORT).show();
            Log.d(TAG, "BusinessHeadPolicyActivity basic setup completed");
                ...
                try {
                    runOnUiThread(() -> {
                        try {
                            ...
                            loadDropdownData();
                            loadPolicyData();
                            Log.d(TAG, "All BusinessHeadPolicyActivity components initialized successfully");
                        } catch (Exception e) {
                            Log.e(TAG, "Error in UI initialization: " + e.getMessage(), e);
                            Toast.makeText(BusinessHeadPolicyActivity.this, "Error initializing components: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                } catch (Exception e) {
            ...
            Log.e(TAG, "Error in BusinessHeadPolicyActivity onCreate: " + e.getMessage(), e);
            Toast.makeText(this, "Error loading Business Head Policy panel: " + e.getMessage(), Toast.LENGTH_LONG).show();
            finish();
        }
    }
            ...
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    if ("success".equals(status)) {
                        Toast.makeText(BusinessHeadPolicyActivity.this, "Policy submitted successfully!", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(BusinessHeadPolicyActivity.this, "Error: " + errorMsg, Toast.LENGTH_LONG).show();
                    }
                });
                ...
                runOnUiThread(() -> {
                    submitButton.setEnabled(true);
                    submitButton.setText("Submit");
                    Toast.makeText(BusinessHeadPolicyActivity.this, "Error submitting policy: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
            }
        }).start();
    }
                    ...
                    if (json.getString("status").equals("success")) {
                        ...
                        runOnUiThread(() -> {
                            ArrayAdapter<String> loanTypeAdapter = new ArrayAdapter<>(
                                BusinessHeadPolicyActivity.this, 
    ...
    private void loadPolicyData() {
        ...
        new Thread(() -> {
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (json.getString("status").equals("success")) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            policyList.add(new PolicyActivity.PolicyItem(
                        ...
                        runOnUiThread(() -> {
                            ...
                            Toast.makeText(BusinessHeadPolicyActivity.this, 
                    ...
                    runOnUiThread(() -> {
                        showLoading(false);
                        Toast.makeText(BusinessHeadPolicyActivity.this, "Server error: " + responseCode, Toast.LENGTH_LONG).show();
                        loadSampleData(); // Fallback to sample data
                    });
                }
            } catch (Exception e) {
                ...
                runOnUiThread(() -> {
                    showLoading(false);
                    Toast.makeText(BusinessHeadPolicyActivity.this, "Error loading policies: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    loadSampleData(); // Fallback to sample data
                });
            }
        }).start();
    ...
    private void filterPolicies() {
        ...
        filteredList.clear();
        for (PolicyActivity.PolicyItem policy : policyList) {
