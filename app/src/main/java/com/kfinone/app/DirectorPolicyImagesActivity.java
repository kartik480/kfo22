...
public class DirectorPolicyImagesActivity extends AppCompatActivity {

    private TextView userNameText;
    private ImageView backButton;
    private RecyclerView policyImagesRecyclerView;
    private DirectorPolicyImagesAdapter policyImagesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_director_policy_images);
    ...
    private void setupRecyclerView() {
        policyImagesAdapter = new DirectorPolicyImagesAdapter(this, new ArrayList<>());
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (success) {
                        ...
                        List<DirectorPolicyImagesActivity.PolicyImageItem> policyImagesList = new ArrayList<>();
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            if ("1".equals(status)) {
                                ...
                                policyImagesList.add(new DirectorPolicyImagesActivity.PolicyImageItem(id, name, image, status));
                            } else {
