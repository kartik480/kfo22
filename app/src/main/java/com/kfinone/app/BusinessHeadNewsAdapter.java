...
public class BusinessHeadNewsAdapter extends RecyclerView.Adapter<BusinessHeadNewsAdapter.NewsViewHolder> {

    private List<BusinessHeadNewsActivity.NewsItem> newsList;
    private Context context;

    public BusinessHeadNewsAdapter(Context context, List<BusinessHeadNewsActivity.NewsItem> newsList) {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business_head_news, parent, false);
        return new NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        BusinessHeadNewsActivity.NewsItem news = newsList.get(position);
    ...
    public void updateNewsList(List<BusinessHeadNewsActivity.NewsItem> newNewsList) {
        this.newsList.clear();
