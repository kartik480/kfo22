...
public class BusinessHeadManageIcon {
    private String id;
    ...
    public BusinessHeadManageIcon(String id, String iconName, String iconUrl, String iconImage, String iconDescription, String status) {
        this.id = id;
