...
public class BusinessHeadMyAgentActivity extends AppCompatActivity {
    ...
    private void loadActiveAgentList() {
        addAgentItem("John Doe", "1234567890", "john@example.com", "******", "Admin User");
        addAgentItem("Jane Smith", "9876543210", "jane@example.com", "******", "Business Head");
        addAgentItem("Mike Johnson", "5555555555", "mike@example.com", "******", "Manager");
    }
